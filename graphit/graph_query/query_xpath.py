...
def get_root(graph, loc=None, exp=None, attr=None):
    ...
    return root.query_nodes({graph.key_tag: exp})
...
def get_self(graph, loc=None, exp=None, attr=None):
    ...
    if exp not in (None, '*'):
        graph = graph.query_nodes({graph.key_tag: exp})
...
def search_child(graph, loc=None, exp=None, attr=None):
    ...
    if exp not in (None, '*'):
        children = children.query_nodes({graph.key_tag: exp})
...
def search_descendants(graph, loc=None, exp=None, attr=None):
    ...
    if exp not in (None, '*'):
        descendants = descendants.query_nodes({graph.key_tag: exp})
...
def search_siblings(graph, loc=None, exp=None, attr=None):
    ...
    if exp not in (None, '*'):
        siblings = siblings.query_nodes({graph.key_tag: exp})
...
def search_ancestors(graph, loc=None, exp=None, attr=None):
    ...
    if exp not in (None, '*'):
        ancestors = ancestors.query_nodes({graph.key_tag: exp})
